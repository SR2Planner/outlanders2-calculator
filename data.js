...
const RESOURCES = [
    ...
    { id: 'stone', name: 'Stone', source: 'Produced at Quarry or Stone Mine (6 logs → 4 stone in Stone Mine).' },
    { id: 'clay', name: 'Clay', source: 'Produced by Clay Pit.' },
    { id: 'bricks', name: 'Bricks', source: 'Produced by Brickyard (1 stick + 8 clay → 8 bricks).' },
    { id: 'reeds', name: 'Reeds', source: 'Gathered by Reed Harvester.' },
    { id: 'glass', name: 'Glass', source: 'Produced from.' }
  ...
  const BUILDINGS = [
    ...
    { id: 'outpost', name: 'Trading Outpost', category: 'infrastructure', cost: { planks: 6, stone: 12 } },
    ...
    { id: 'bookWorkshop', name: 'Book Workshop', category: 'lifestyle', cost: { stone: 12, planks: 8 } },
    { id: 'canteen', name: 'Canteen Factory', category: 'lifestyle', cost: { bricks: 16, planks: 6 } },
    { id: 'swimming', name: 'Swimming Pier', category: 'lifestyle', cost: { stone: 16, planks: 8 } },
    { id: 'bottleFactory', name: 'Bottle Factory', category: 'lifestyle', cost: { bricks: 6, clay: 6 } },
    ...
    { id: 'craftshop', name: 'Pendant Craftshop', category: 'lifestyle', cost: { stone: 4, bricks: 8 } },
